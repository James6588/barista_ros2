...
def gen_robot_list(num_r):
    ...
    robots = []
    pose_1 = [8.105859, -9.740719]
    pose_2 = [8.105859, -8.688673]
    pose_3 = [8.4302, -7.6321]
    ...
    for i in range(number_of_robots):
        ...
        robots.append({'name': robot_name, 'x_pose': x_pos, 'y_pose': y_pos, 'z_pose': 0.1, 'Y_pose': 0.0})
...
def launch_setup(context, *args, **kwargs):
    ...
    launch_file_dir = os.path.join(get_package_share_directory('barista_ros2_ff'), 'launch')
    ...
    for robot in robots:
        spawn_robots_cmds.append(
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(os.path.join(launch_file_dir, 'spawn.launch.py')),
                launch_arguments={
...
def generate_launch_description(): 
    ...
    number_of_robots_arg = DeclareLaunchArgument('number_of_robots', default_value='3')
